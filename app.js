...
app.get('/posts/:postName', (req, res) => {
  ...
  displayPost = req.params;
  //console.log(displayPost.postName);

  Post.findOne({ _id: displayPost.postName }, function(err, foundPost){
    if(!err){
  ...
  /*
  const titleRequest = _.lowerCase(req.params.postTitle);
